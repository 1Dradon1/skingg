class CONFIG:
    ...
    white_list_path = "D:\\GitHub\\skingg\\new_life\\white_list.txt"  # полный путь до whitelist'а
    ...
    brute_force_mode = 2  # 0-без фильтра  1-blacklist  2-whitelist | стандартно 0
    min_price = 0  # минимальная цена для покупки в долларах | стандартно 0
    max_price = 100  # максимальная цена для покупки в долларах | стандартно 100
